...
EDIT_SAVE_AS_BUTTON = "Salvar como..."
...
CONVERT_INSPECTING = "Inspecionando {count} arquivo(s)…"
CONVERT_REJECTED = "Estes arquivos foram ignorados:"
...
EXPORT_QUALITY_TIP = (
    "Controla a fidelidade de imagem e o tamanho final do arquivo.\n"
    "Equilibrada (CRF 23): excelente qualidade visual indistinguível a olho nu e arquivo leve (recomendado).\n"
    "Alta (CRF 18): qualidade máxima para arquivamento, gerando arquivos significativamente maiores.\n"
    "Econômica (CRF 28): compressão agressiva com arquivo muito compacto, ideal para envio rápido."
)
EXPORT_QUALITY_BALANCED = "Equilibrada (CRF 23 - recomendada)"
EXPORT_QUALITY_HIGH = "Alta qualidade (CRF 18 - arquivo maior)"
EXPORT_QUALITY_ECONOMY = "Econômica (CRF 28 - arquivo leve)"
...
EDIT_SNAP = "🧲"
EDIT_SNAP_TIP = "Alinhamento magnético às bordas e rotação (Auto-attach)"
EDIT_PROPERTIES = "Propriedades"
EDIT_PROPERTIES_TIP = "Abrir aba de propriedades com edição numérica precisa do item"
EDIT_TAB_PROPERTIES = "Propriedades"
EDIT_MUTE = "Silenciar"
...
EDIT_SPEED_TIP = "Ajustar velocidade de reprodução do bloco (0,1x a 10x)"
...
EDIT_FAST_UNAVAILABLE = (
    "O corte rápido vale enquanto a edição for um recorte de um arquivo só, na "
    "tela e na taxa dele. Com mais de um bloco, mídia acrescentada, volume "
    "alterado, trilha sobreposta ou outra tela escolhida, a exportação precisa "
    "compor — e compor recodifica."
)
EDIT_DRIFT = (
