...
from ...core.composer import audio_command, frame_command, playback_command, simple_trim
from ...core.converter import LocalMedia
...
from ..text_renderer import configure_text_renderer
...
from .edit_widgets import (
    _index_of as _index_of,
    _VolumePopup as _VolumePopup,
    _SpeedPopup as _SpeedPopup,
    _Preview as _Preview,
    _ClipPropertiesWidget as _ClipPropertiesWidget,
    _MediaListWidget as _MediaListWidget,
    _FontSelectorWidget as _FontSelectorWidget,
)
...
class EditPanel(QWidget):
    ...
    def __init__(
        ...
        self._future = self._session.future
